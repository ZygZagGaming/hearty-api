...
public class HalfHeartContext extends HeartContext {
    ...
    public HalfHeartContext(Minecraft minecraft, HeartyRegistries registries, Player player, Gui gui, GuiGraphics graphics, int x, int y, int heartIndex, HeartType heartType, ResourceLocation sprite, int halfHeartIndex) {
    ...
    public HalfHeartContext(HeartContext ctx, HeartType heartType, ResourceLocation sprite, int halfHeartIndex) {
        this(ctx.minecraft(), ctx.registries(), ctx.player(), ctx.gui(), ctx.graphics(), ctx.x(), ctx.y(), ctx.heartIndex(), heartType, sprite, halfHeartIndex);
    }
    ...
    public HalfHeartContext withSprite(ResourceLocation newSprite) {
        return new HalfHeartContext(minecraft(), registries(), player(), gui(), graphics(), x(), y(), heartIndex(), heartType(), newSprite, halfHeartIndex());
    }
